...
static int SocketServerCreate(SOCKET *hSocket) {
  ...
  // Setup serverSocketAddressInfoHints to give hints to API how to set up
  // socket address structure.
  ZeroMemory(&serverSocketAddressInfoHints,
             sizeof(serverSocketAddressInfoHints));
  ...
  apiResponse =
      getaddrinfo(NULL, DEFAULT_SOCKET_PORT, &serverSocketAddressInfoHints,
  ...
  *hSocket = socket(serverSocketAddressInfo->ai_family,
  ...
  apiResponse = bind(*hSocket, serverSocketAddressInfo->ai_addr,
                     (int)serverSocketAddressInfo->ai_addrlen);
